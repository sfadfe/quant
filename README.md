...
| --- | --- | --- |
| `kv_mib_per_tok` | MiB of KV (+activation slack) per context token in the projection | Fit from a short fixed-W4 or Adaptive session: $\Delta$`alloc_mib`$/\Delta L$. Default here ≈ **0.23** for Qwen3-8B, bs=1. |
